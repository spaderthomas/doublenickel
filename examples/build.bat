...
CALL %DN_BUILD_TOOLS% :DN_NORMALIZE_PATH "%DN_EXAMPLES_DIR%\%PROJECT%" PROJECT_DIR
...
:BUILD
  ...
  SET "OUTPUT_FLAGS=/Fe%BUILD_DIR%\%EXECUTABLE% /Fo%OBJECT_DIR% /Fd%PDB_DIR%"
  SET "RUNTIME_FLAGS=/MDd"
  SET "EXTRA_FLAGS=/Od /JMC /EHa /nologo"
...
:PREBUILD
  ...
  CALL %DN_BUILD_TOOLS% :DN_COPY_PDBS %BUILD_DIR%
