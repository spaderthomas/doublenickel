...
function DialogueController:load_dialogue(dialogue)
  if not dialogue then
    tdengine.dn_log(string.format('controller got bad dialogue param, dialogue = %s', dialogue))
...
function DialogueController:change_dialogue(dialogue)
  ...
  if not dialogue then
    tdengine.dn_log(string.format('DialogueController::change_dialogue(): bad dialogue, name = %s', dialogue))
    self:update_state(dialogue_state.err)
    return
  end
